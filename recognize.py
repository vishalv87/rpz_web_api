...
def perform_recognition(mock_args, chessboard_image_path):
    ...
    # json_data = {"quiet": False, "debug": False, "image_path": chessboard_image_path}
    # data_dict = json.loads(json_data)

    # Chessboard = namedtuple("Chessboard", data_dict.keys())
    # chessboard = Chessboard(*data_dict.values())

    print(mock_args)

    response = predict_chessboard(chessboard_image_path, args)
    return response
